package com.example.androidmaster.memorise.kotlin_memorise_fragment;
 ...
 */
public class Kotlin_p02_MemorizeRecV extends Fragment {
...
//    private RecyclerView mRecycler_Memorize;
    ...
    View rootView;
    public Kotlin_p02_MemorizeRecV() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("kotlin_mem_p02");
                    ...
                    protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("childName", "kotlin_mem_p02");
