package com.example.androidmaster.memorise.java_memorise_fragment;
 ...
 */
public class Java_p02_MemorizeRecV extends Fragment {
...
//    private RecyclerView mRecycler_Memorize;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("java_mem_p02");
                    ...
                    protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("childName", "java_mem_p02");
