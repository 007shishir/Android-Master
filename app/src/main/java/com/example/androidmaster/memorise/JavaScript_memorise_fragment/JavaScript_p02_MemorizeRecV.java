 ...
 */
public class JavaScript_p02_MemorizeRecV extends Fragment {
...
//    private RecyclerView mRecycler_Memorize;
    ...
    View rootView;
    public JavaScript_p02_MemorizeRecV() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("javascript_mem_p02");
                    ...
                    protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("childName", "javascript_mem_p02");
