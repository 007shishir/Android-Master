    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                Navigation.findNavController(v).navigate(R.id.action_html_tutorial_to_memorise_recV);
                break;
            case R.id.mTxt_and_mem_p02:
                Navigation.findNavController(v).navigate(R.id.action_html_tutorial_to_memorise_recV_p2);
                break;
