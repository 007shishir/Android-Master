 ...
 */
public class Excel_2010_Tutorial extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                memorise_p01.putString("child_name", "excel2010_mem_p01");
                Navigation.findNavController(v).navigate(R.id.action_excel_2010_tutorial_to_memorise_recV, memorise_p01);
                break;
