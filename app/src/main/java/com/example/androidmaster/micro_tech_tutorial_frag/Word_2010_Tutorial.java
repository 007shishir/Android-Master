 ...
 */
public class Word_2010_Tutorial extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                memorise_p01.putString("child_name", "word2010_mem_p01");
                Navigation.findNavController(v).navigate(R.id.action_word_2010_tutorial_to_memorise_recV, memorise_p01);
                break;
