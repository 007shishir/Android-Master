    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                memorise_p01.putString("child_name", "rest_api_mem_p01");
                Navigation.findNavController(v).navigate(R.id.action_rest_api_tutorial_to_memorise_recV, memorise_p01);
                break;
            case R.id.mTxt_and_mem_p02:
                Bundle memorise_p02 = new Bundle();
                memorise_p02.putString("child_name", "rest_api_mem_p02");
                Navigation.findNavController(v).navigate(R.id.action_rest_api_tutorial_to_memorise_recV, memorise_p02);                break;
