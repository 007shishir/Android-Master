    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                Navigation.findNavController(v).navigate(R.id.action_javaScript_tutorial_to_javaScript_p01_memorizeRecV);
                break;
            case R.id.mTxt_and_mem_p02:
                Navigation.findNavController(v).navigate(R.id.action_javaScript_tutorial_to_javaScript_p02_memorizeRecV);
                break;
