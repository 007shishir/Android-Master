    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                Navigation.findNavController(v).navigate(R.id.action_mvvm_tutorial_to_mvvm_p01_memorizeRecV);
                break;
            case R.id.mTxt_and_mem_p02:
                Navigation.findNavController(v).navigate(R.id.action_mvvm_tutorial_to_mvvm_p02_memorizeRecV);
                break;
